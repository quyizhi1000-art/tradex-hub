...
BUSINESS_RULES: tuple[BusinessRule, ...] = (
    BusinessRule("storage", "存储", _patterns(
        r"存储", r"固态硬盘", r"\bSSD\b", r"\bNAND\b", r"\bDRAM\b",
        r"\beMMC\b", r"\bUFS\b", r"内存条", r"闪存",
    )),
    ...
    BusinessRule("semiconductor_material", "半导体材料", _patterns(r"半导体材料", r"硅片", r"光刻胶", r"电子特气")),
    BusinessRule("chip_design", "芯片设计", _patterns(r"芯片设计", r"集成电路设计", r"控制芯片", r"处理器芯片")),
    ...
    BusinessRule("photovoltaic", "光伏", _patterns(r"光伏", r"太阳能电池", r"硅料", r"硅棒", r"硅片")),
    ...
    BusinessRule("precious_metals", "贵金属", _patterns(r"黄金", r"白银", r"贵金属")),
    ...
    BusinessRule("medical_devices", "医疗器械", _patterns(r"医疗器械", r"医疗设备", r"诊断试剂")),
