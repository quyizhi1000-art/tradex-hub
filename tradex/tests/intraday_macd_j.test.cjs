...
function harness() {
  ...
  for (const name of ['stockSelectionIndustryName', 'stockSelectionIndustryPayload',
    'stockSelectionDisplayCandidates', 'appendMacdPriceEvidence', 'macdStateLabel', 'appendMacdStateEvidence', 'renderMacdPending', 'renderIntradayMacdJIndustryFilters', 'selectIntradayMacdJScan']) {
